    ...
    return (
       <div className='pt-24 px-3'>
        <div className='mb-5 pb-7'>
            <h2 className='text-3xl font-bold'>Featured topics by category</h2>
        </div>
         <div className='grid grid-cols-2 lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 xsm:grid-cols-1  gap-5'>
