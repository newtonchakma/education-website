        ...
        <div className="container mx-auto flex items-center 
         h-full">
            <div className="flex flex-col items-center pt-5 mt-5 rounded-lg text-center mb-10 md:mb-0 md:w-[800px] mx-4 md:mx-0">
                <h1 className="title-font sm:text-2xl text-3xl md:text-5xl uppercase mb-4 font-medium text-white">Experience a learning 
                    <br className="hidden lg:inline-block"/> platform that take you
                    <br className="hidden lg:inline-block"/> next level.
                </h1>
                <p className="leading-relaxed md:text-xl text-secondary pl-10 ">World-class training and development programs developed by top teachers</p>
