    ...
    return (
        <div id='contact' className='px-5 h-[550px] bg-base-200 rounded-lg'>
            <div className='my-6 mt-5 pt-5 font-bold text-center'>
                <h1 className='font md:text-4xl pt-9 mt-8 text-2xl '>Have Any Question ? <span className='text-accent'>Contact Us</span></h1>
            </div>
            <div className='w-[750] mt-4 pt-5 mx-auto max-w-xl'>
                ...
                <button className="btn btn-wide my-8 btn-accent font-bold font">Send</button>
                </div>
                </form>
            </div>
        </div>
